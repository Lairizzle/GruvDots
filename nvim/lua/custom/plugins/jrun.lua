...
--return {
--  {
--    'nvim-lua/plenary.nvim', -- a harmless, always-used plugin
--    name = 'jrun', -- optional name
--    lazy = false,
--    config = function()
...
--
--          -- Compile using jobstart
--          vim.fn.jobstart(compile_cmd, {
--            stdout_buffered = true,
--            stderr_buffered = true,
--            on_exit = function(_, code)
--              if code == 0 then
--                -- Compilation successful: open floating terminal and run
...
--      end
--
--      vim.keymap.set('n', '<leader>jr', run_java, { desc = 'Run Java in floating terminal', noremap = true, silent = true })
--    end,
--  },
--}
